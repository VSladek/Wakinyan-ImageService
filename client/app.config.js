...
const roleConfig = {
  admin: {
    ...
    bundleIdentifier: 'cz.yourorg.imageservice.admin',
    package: 'cz.yourorg.imageservice.admin',
  ...
  consumer: {
    ...
    bundleIdentifier: 'cz.yourorg.imageservice.consumer',
    package: 'cz.yourorg.imageservice.consumer',
